...
var Body = class {
  ...
  async formData() {
    ...
    const { toFormData } = await Promise.resolve().then(() => __toESM(__require("./multipart-parser-IJ6M5SUI.mjs"), 1));
...
var getCsrfToken = async () => {
  ...
  const csrfToken = ((_a = setCookieHeader == null ? void 0 : setCookieHeader.match(/csrftoken=(.*?);/)) == null ? void 0 : _a[1]) || "";
  return csrfToken;
};
var getIgSessionId = async (username, password) => {
  ...
  if (authenticated) {
    let session_id = ((_b = (_a = res.headers.get("set-cookie")) == null ? void 0 : _a.match(/sessionid=(.*?);/)) == null ? void 0 : _b[1]) || "";
    return session_id;
  }
...
async function getIgFollowerCount(username, sessionId) {
  ...
  return ((_c = (_b = (_a = data.graphql) == null ? void 0 : _a.user) == null ? void 0 : _b.edge_followed_by) == null ? void 0 : _c.count) || 0;
}
...
var getBrowserContext = async ({
  ...
  context = await browser.newContext(__spreadValues({}, devices["iPhone 12"]));
  return context;
};
